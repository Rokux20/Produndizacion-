...
{
    /// <inheritdoc />
    public partial class prueba1111 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdAttendeeR = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdAttendee = table.Column<int>(type: "int", nullable: false),
                    attendeeIdAttendee = table.Column<int>(type: "int", nullable: true),
                    IdRoom = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_roomAttendeeRegistration", x => x.IdAttendeeR);
                    table.ForeignKey(
